		...
		<div class="flex-wrapper">
			...
			<div class="wrapper" class:mobileActive>
				<ul class="nav-list">
					...
					<li class="mobile">
						<a href="mailto:pi.sulaiman12@gmail.com" target="_blank" in:mobileTransitionSwitcher={{ delay: 350 }}>Email</a>
					</li>
					<li bind:this={githubElem}>
						<a href="https://almas-art.vercel.app/" in:mobileTransitionSwitcher={{ delay: 400 }}>All Work</a>
					</li>
					{/key}
				</ul>
			</div>
