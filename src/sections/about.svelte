...
<div id="content-container" class="about" bind:this={aboutSection1Container}>
	<div class="content-wrapper">
		...
		<div bind:this={paragraph}>
			<p class="paragraph">
				I'm Almas Fathima, and I wear two hats with equal passion and dedication. As a teacher, I strive to ignite the spark of knowledge in my students, while my expertise as a professional calligraphy artist allows me to craft beauty and meaning through the strokes of my pen.
			</p>
		</div>
		<div class="social-button-wrapper">
			...
			<div  bind:this={githubLink}>
				<span class="button" bind:this={githubLink}><a href="https://www.instagram.com/arshii_almas_24/" target="_blank" class="clickable sublink link">Instagram</a></span>
			</div>
		</div>
	</div>
